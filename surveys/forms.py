...
class FlexiForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['qid'] = forms.CharField(label='qid', max_length=10, widget=forms.HiddenInput())
    ...
    def save(self, request):
        ...
        earlier = Answer.objects.filter(question_id=qid, department_id=self.department.pk).first()
        if earlier:
            earlier.delete()
        Answer.objects.create(question=question, department=self.department, option=option)
